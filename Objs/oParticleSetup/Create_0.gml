particleSystem=part_system_create_layer("Player",0);

particleType_Hit= part_type_create();
part_type_sprite(	  particleType_Hit,sFireballSpark,0,0,0);
...
part_type_orientation(particleType_Hit, 0, 359, 0, 0, 1);

particleType_Spark=part_type_create();
part_type_sprite(	  particleType_Spark,HitSpark2,0,0,0);
part_type_size(		  particleType_Spark, 0.8,1.4,-0.1,0);
...
part_type_colour3(	  particleType_Spark,c_red, c_white, c_maroon);
